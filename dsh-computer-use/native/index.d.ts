...
export type WindowIdentity = { windowId: number; title: string; className: string; appName: string; processId: number; processPath: string; rect: Rect; visible: boolean; minimized: boolean; onScreen: boolean; foreground: boolean; dpi: number }
...
export function captureScreen(path: string): boolean
...
export function postChar(windowId: number, text: string): boolean
